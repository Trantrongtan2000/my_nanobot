...
- Short progress updates (1-liner) on long tasks + **ALWAYS state planned action FIRST** before executing tools
- Informal messages/typos OK → execute immediately after stating the planned action
- Vietnamese default
